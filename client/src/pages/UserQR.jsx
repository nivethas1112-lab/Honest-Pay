                ...
                <td>
                  <div className="user-info-cell">
                    ...
                    <div className="details">
                      <span className="name">QR-USR-{100+i}</span>
                    </div>
                  </div>
                </td>
                <td>
                  <div className="details">
                    <span className="name">User #{100+i}</span>
                    <span className="email text-muted">WAL-4592{i}</span>
                  </div>
                </td>
                <td><span className="badge-outline">User Profile</span></td>
                <td>{120 * i} Scans</td>
                <td>2 hours ago</td>
